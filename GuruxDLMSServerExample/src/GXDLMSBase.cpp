...
void AddActivityCalendar(CGXDLMSObjectCollection& items)
{
    ...
    auto t = CGXDateTime(-1, 3, 31, 0, 0, 0, 0);
    auto seasonProfile = new CGXDLMSSeasonProfile("Summer time", t, "");
    pActivity->GetSeasonProfileActive().push_back(seasonProfile);
    ...
    auto t2 = CGXDateTime(-1, 10, 30, 0, 0, 0, 0);
    pActivity->GetSeasonProfilePassive().push_back(new CGXDLMSSeasonProfile("Winter time", t2, ""));
...
void AddDemandRegister(CGXDLMSObjectCollection& items)
{
    ...
    pDr->SetStatus(1);
    auto t = CGXDateTime::Now();
    pDr->SetStartTimeCurrent(t);
    pDr->SetCaptureTime(t);
    pDr->SetPeriod(10);
